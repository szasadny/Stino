...
frontend/
  src/
    lib/
      ...
      components/       # calendar cell (+ mobile readable cell), task row, label chip, day sheet, day list section (mobile week), quick-add, search dialog
    views/             # MonthView, WeekView, Today, Inbox (day zoom = DaySheet overlay, opened from a desktop grid cell or a phone day-section tap; search is an overlay, not a tab)
